...
const HeroSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-green-50 pt-20">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className={`max-w-5xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          {/* Animated Badge */}
          {/* <div className="inline-flex items-center px-5 py-2.5 bg-white/60 backdrop-blur-md text-green-800 rounded-full text-xs sm:text-sm font-semibold mb-6 border border-green-200/50 shadow-soft hover:bg-white transition-all duration-300 hover:scale-105">
            <span className="relative flex h-2 w-2 mr-3">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
            </span>
            TRANSFORMING COMMUNITIES SINCE 2020
          </div> */}
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-8 text-gray-700 max-w-3xl mx-auto leading-relaxed px-4">
            Building sustainable communities through empowerment, and collaborative action that creates lasting impact across rural Bengal.
          </p>
...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-16 sm:py-20 lg:py-24 relative overflow-hidden" style={{ backgroundColor: '#bfedbfaa' }}>
      {/* Background */}
      <div className="absolute inset-0">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
            {contentCards.map((item, i) => (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${item.color} opacity-0 group-hover:opacity-10 rounded-3xl transition-all duration-500 transform group-hover:scale-105`}></div>
                <div className="relative bg-white rounded-3xl p-6 sm:p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-green-200">
                  <div className="relative inline-block mb-4">
                    <div className={`absolute inset-0 bg-gradient-to-br ${item.color} opacity-20 rounded-2xl blur-xl transform group-hover:scale-150 transition-transform duration-500`}></div>
                    <div className={`relative w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br ${item.color} rounded-2xl flex items-center justify-center text-3xl sm:text-4xl transform group-hover:rotate-12 transition-transform duration-500 shadow-lg`}>
                      {item.icon}
                    </div>
                  </div>
            ...
            {images.map((img, index) => (
              <div 
                ...
                className={`group relative transform transition-all duration-700 ${
                  imagesLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                }`}
                style={{ transitionDelay: `${index * 100}ms` }}
              >
                <div className="relative">
                  <div className={`absolute -inset-1 bg-gradient-to-r ${img.gradient} rounded-3xl opacity-0 group-hover:opacity-100 blur-lg transition-all duration-500`}></div>
...
const CoreValuesSection = () => {
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 relative overflow-hidden bg-gradient-to-b from-white via-green-50/30 to-white" style={{ backgroundColor: '#bfedbfaa' }}>
      <div className="absolute inset-0">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 sm:mb-6 text-gray-900">
            Core <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">Values</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-7xl mx-auto">
          {values.map((value, index) => (
            ...
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${value.gradient} opacity-0 group-hover:opacity-10 rounded-3xl transition-all duration-500 transform group-hover:scale-110 blur-xl`}></div>
              
              <div className={`relative bg-gradient-to-br ${value.bgGradient} backdrop-blur-sm rounded-3xl p-6 sm:p-8 h-full shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-white/50`}>
                <div className="relative mb-6">
                  <div className={`absolute inset-0 bg-gradient-to-br ${value.gradient} rounded-2xl opacity-20 blur-xl transform group-hover:scale-150 transition-transform duration-500`}></div>
                  <div className={`relative w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br ${value.gradient} rounded-2xl flex items-center justify-center text-3xl sm:text-4xl transform group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-xl`}>
                    <img 
                      src={value.icon} 
                      alt={value.title} 
                ...
                <p className={`text-xs sm:text-sm text-gray-500 italic transition-all duration-500 ${
                  hoveredValue === index ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-2'
                }`}>
                  {value.details}
                </p>

                <div className="mt-4 h-1 bg-gray-200 rounded-full overflow-hidden">
                  <div className={`h-full bg-gradient-to-r ${value.gradient} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-left`}></div>
                </div>
              </div>
            </div>
          ))}
  ...
  const testimonials = [
    {
      ...
      content: "ChangeSpark has transformed our village. The education programs have given our children hope and opportunities we never thought possible. Their dedication is truly remarkable.",
      rating: 5,
    ...
    },
    {
      ...
      content: "The skill development programs for women have empowered my wife to start her own business. Our family's life has completely changed for the better.",
      rating: 5,
    ...
    },
    {
      ...
      role: "School Teacher",
      location: "Kolkata",
      content: "Working with ChangeSpark has been incredibly rewarding. Their innovative approach to education is making a real difference in our community.",
      rating: 5,
    ...
    <section className="py-16 sm:py-20 lg:py-24 relative overflow-hidden bg-gradient-to-b from-green-50 to-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 sm:mb-6 text-gray-900">
            Voices of <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">Change</span>
          </h2>
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-12 relative overflow-hidden transform transition-all duration-500"
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h4 className="text-lg sm:text-xl font-bold text-gray-800">{testimonials[activeTestimonial].name}</h4>
                      <p className="text-sm sm:text-base text-gray-600">{testimonials[activeTestimonial].role}</p>
                      <p className="text-xs sm:text-sm text-gray-500">{testimonials[activeTestimonial].location}</p>
                    </div>
                  </div>
                </div>
              </div>
