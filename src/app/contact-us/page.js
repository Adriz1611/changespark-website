...
const ContactCard = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute -inset-[2px] bg-gradient-to-r ${gradientFrom} ${gradientTo} rounded-2xl opacity-0 group-hover:opacity-70 blur-xl transition-all duration-500`}
      />
    ...
    >
      <div className="relative h-14 w-14 grid place-items-center rounded-xl bg-white shadow-lg ring-1 ring-black/5 transition-all duration-300 group-hover:shadow-xl group-hover:ring-emerald-200">
        ...
        {React.cloneElement(icon, {
          className:
            "w-5 h-5 text-gray-700 group-hover:text-emerald-700 transition-colors relative z-10",
        })}
      </div>
  ...
  const contactItems = [
    {
      ...
      description:
        "Got a question or feedback? Email us and we'll get back to you as soon as we can. Your thoughts are important to us, and we are here to help!",
    ...
    },
    {
      ...
      description:
        "Prefer to chat or call? We are available to discuss how we can work together to empower communities and ignite change.",
      ...
      <section className="relative py-32 lg:py-40 bg-gradient-to-br from-emerald-900 via-green-800 to-teal-900 text-white overflow-hidden">
        ...
        >
          <div className="text-center max-w-5xl mx-auto">
            ...
            >
              Ready to make a difference? We are here to collaborate, listen,
      ...
      <section className="py-20 lg:py-28 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          >
            ...
            >
              Choose your preferred way to connect with us. We're always eager
              to hear from you.
            </motion.p>
          </motion.div>
            ...
            >
              ...
              >
                <p className="text-xl font-medium text-gray-700 italic relative">
                  <span className="absolute -top-4 -left-2 text-5xl text-emerald-200">
                    "
                  </span>
                  At Changespark Foundation, your journey with us begins
                  here—let's spark change together!
                  <span className="absolute -bottom-6 -right-2 text-5xl text-emerald-200">
                    "
                  </span>
                </p>
              </motion.blockquote>
