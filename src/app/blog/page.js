...
export default function Component() {
  return (
    <div className="bg-background-100 text-foreground pb-24">
        ...
        <div className="prose prose-lg prose-neutral mx-auto max-w-3xl dark:prose-invert text-text-700">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                className="text-muted-foreground hover:bg-muted/50 p-2 rounded-full"
                aria-label="Like"
              >
      ...
      <section className="container mx-auto mt-12 px-4 sm:mt-16 sm:px-6 lg:mt-20 lg:px-8">
