...
function TestimonialCard({ quote, author }) {
  return (
    <motion.div
      className="max-w-md rounded-xl overflow-hidden shadow-xl bg-background-200 p-8 m-4 border border-purple-100"
    ...
    >
      <div className="relative">
        <svg
          className="absolute top-0 left-0 w-16 h-16 text-secondary-500 transform -translate-x-6 -translate-y-6"
          fill="currentColor"
          viewBox="0 0 32 32"
          aria-hidden="true"
        >
        ...
        <p className="relative z-10 text-black text-lg leading-relaxed font-paragraph pt-8">
          {quote}
        </p>
      </div>
...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="bg-background-100 min-h-screen p-10">
